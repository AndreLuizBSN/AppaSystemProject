...
@Named
@ViewScoped
public class PesquisaManutencaoPessoasBean implements Serializable {
	...
	public PesquisaManutencaoPessoasBean(){
	...
	public void ativarDesativar(Long id, boolean ativo){
		...
		FacesUtil.addInfoMessage("Pessoa "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" "+texto+" com sucesso!");
