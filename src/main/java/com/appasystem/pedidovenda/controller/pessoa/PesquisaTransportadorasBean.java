...
@Named
@ViewScoped
public class PesquisaTransportadorasBean implements Serializable {
	...
	public PesquisaTransportadorasBean(){
	...
	public void excluir(Long id){
		...
		FacesUtil.addInfoMessage("Transportadora "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" excluída com sucesso!");
	...
	public void ativarDesativar(Long id, boolean ativo){
		...
		FacesUtil.addInfoMessage("Transportadora "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" "+texto+" com sucesso!");
		
	}
	
	public void pesquisar(){
		
		this.filtro.setCliente(AtivoInativoTodos.TODOS);
		this.filtro.setFornecedor(AtivoInativoTodos.TODOS);
		this.filtro.setFuncionario(AtivoInativoTodos.TODOS);
		this.filtro.setTransportadora(AtivoInativoTodos.ATIVO);
