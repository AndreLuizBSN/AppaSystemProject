...
public class PesquisaFuncionariosBean implements Serializable {
	...
	public void excluir(Long id){
		...
		FacesUtil.addInfoMessage("Funcionário "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" excluído com sucesso!");
	...
	public void ativarDesativar(Long id, boolean ativo){
		...
		FacesUtil.addInfoMessage("Funcionário "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" "+texto+" com sucesso!");
	...
	public void pesquisar(){
		...
		this.filtro.setFuncionario(AtivoInativoTodos.ATIVO);
