...
public class PesquisaFornecedoresBean implements Serializable {
	...
	public void excluir(Long id){
		...
		FacesUtil.addInfoMessage("Fornecedor "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" excluído com sucesso!");
	...
	public void ativarDesativar(Long id, boolean ativo){
		...
		FacesUtil.addInfoMessage("Fornecedor "+pessoaSelecionado.getId()+" - "+pessoaSelecionado.getRazaoSocial()+" "+texto+" com sucesso!");
	...
	public void pesquisar(){
		...
		this.filtro.setFornecedor(AtivoInativoTodos.ATIVO);
