...
@Named
@ViewScoped
public class CadastroContaPagarBean implements Serializable {
	...
	private void limpar(){
		conta = new Conta();
		conta.setEntradaSaida(EntradaSaida.SAIDA);
	}
	...
	public void salvar() {
		...
		this.conta.setEntradaSaida(EntradaSaida.SAIDA);
