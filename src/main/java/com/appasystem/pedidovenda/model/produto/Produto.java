package com.appasystem.pedidovenda.model.produto;
...
public class Produto implements Serializable {
	...
	public void baixarEstoque(Integer quantidade) {
		if(this.getQuantidadeEstoque() < quantidade){
			throw new NegocioException("O item "+this.getSku()+" - "+this.getNome()+" não possui estoque suficiente!");
		}else{
	...
	@Transient
	public void retornarEstoque(Integer quantidade) {
		this.setQuantidadeEstoque(this.getQuantidadeEstoque() + quantidade);
	}
